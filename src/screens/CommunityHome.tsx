...
export const CommunityHome = ({ navigation, route }: Props): JSX.Element => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const mergedPosts = mergeById(store.getState().post.posts, fetchedPosts)
  ...
  return (
    ...
    >
      ...
      <Image
        source={community?.image ? { uri: community.image } : Patronato}
      ...
      <CustomButton
        text="+ Crear Reporte"
        variant="secondary"
        onPress={() => navigation.navigate('ReportProblem', { communityId })}
      />

      {/* FORO */}

      <View style={styles.sectionHeader}>
        <Text style={styles.sectionTitle}>Foro de la comunidad</Text>

        <Pressable
          onPress={() => navigation.navigate('Forum', { communityId })}
        >
          <Text style={styles.sectionLink}>Ver Foro</Text>
        </Pressable>
      </View>
      ...
      <View style={styles.sectionHeader}>
        ...
        <Pressable onPress={() => {}}>
          <Text style={styles.sectionLink}>Ver Noticias</Text>
        </Pressable>
      </View>
